...
public class FlashSaleAdapter extends RecyclerView.Adapter<FlashSaleAdapter.ItemHolder> {
    ...
    public FlashSaleAdapter(Context context, ArrayList<ThietBi> arrThietBi) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        @SuppressLint("InflateParams") View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.dong_thietbiflashsale, null);
